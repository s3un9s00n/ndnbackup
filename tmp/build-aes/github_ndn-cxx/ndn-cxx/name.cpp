...
Name::Name(std::string uri)
{
  ...
  if (uri[0] == '/') {
    ...
    std::string test[] = {"localhost", "ndn", "nfd", "status", "faces", "create", "update", "destroy", "list", "channels", "query", "events", "fib", "add-nexthop", "remove-nexthop", "cs", "config", "erase", "info", "strategy-choice", "set", "unset", "rib", "register", "unregister"};
